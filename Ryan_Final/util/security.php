...
class Security {
    ...
    }//end checkHTTPS function

    //public any need clean-up for loggin out
    public static function logout() {
        unset($_SESSION); //clear the session info

        //clear any post info to prevent back button from allowing
        //user to breach security
        unset($_POST);
    ...
    public static function checkAuthority($auth){
        //check to see if user is authorized - if not, set a message
